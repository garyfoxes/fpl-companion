...
This is the **primary, always-on instruction file** for AI agents working in this repository. Read this file first; no other file is a prerequisite.

Reusable procedural skills live in `.agents/skills/`. GitHub-Copilot-specific agent personas and prompts live under `.github/agents/` and `.github/prompts/`.
...
Skills live under `.agents/skills/`. Load the relevant skill(s) when they match the work.
